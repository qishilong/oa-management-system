...
const AssessmentTable = ({ assessmentList, reloadPage }) => {
    ...
    const handleSave = async (value) => {
        const { code, msg } = await $http.updateAssessment(value);
    ...
    return (
        <Table
            ...
            columns={Columns(handleSave, getAssessmentDetail, userInfo)}
            pagination={false}
            rowSelection={{ onChange: selectRow }}
            loading={loading.effects["assessment/_initAssessmentList"]}
        />
    )
}
